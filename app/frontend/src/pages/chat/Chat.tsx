                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            {/*<SparkleFilled fontSize={"120px"} primaryFill={"rgba(243, 187, 75)"} aria-hidden="true" aria-label="Chat logo" />*/}
                            <img src="/public/bulldog.ico" alt="Chat logo" style={{ width: "120px", height: "120px" }} />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. How do I get a new ID)"
                            disabled={isLoading}
